defmodule PhoenixPath.CatalogTest do
  use PhoenixPath.DataCase

  alias PhoenixPath.Catalog

  describe "products" do
    alias PhoenixPath.Catalog.Product

    import PhoenixPath.CatalogFixtures
    ...
    test "create_product/1 with valid data creates a product" do
      ...
      assert product.price == Decimal.new("120.500000")
  ...
  describe "categories" do
    alias PhoenixPath.Catalog.Category
