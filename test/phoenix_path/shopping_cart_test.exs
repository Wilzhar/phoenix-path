defmodule PhoenixPath.ShoppingCartTest do
  use PhoenixPath.DataCase

  alias PhoenixPath.ShoppingCart

  describe "carts" do
    alias PhoenixPath.ShoppingCart.Cart

    import PhoenixPath.ShoppingCartFixtures
  ...
  describe "cart_items" do
    alias PhoenixPath.ShoppingCart.CartItem
